<x-layouts.app title="Detail User">
    <div class="space-y-6">
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm flex gap-6 items-center">
            ...
            <div class="flex-1">
                <h2 class="text-2xl font-semibold">Dani Afderi</h2>
                <p class="text-gray-600">Safety Officer</p>
    
                <div class="mt-2 flex gap-4 text-sm text-gray-500">
                    <span>Email: dani@example.com</span>
                    <span>ID: USR-9281</span>
        ...
        <div class="grid grid-cols-3 gap-4">
            ...
            <div class="bg-white p-4 rounded-2xl shadow-sm">
                ...
                <h3 class="text-3xl font-semibold mt-2">8</h3>
                <p class="text-sm text-green-600 mt-1">+1 minggu ini</p>
            </div>
    
            <div class="bg-white p-4 rounded-2xl shadow-sm">
                <p class="text-gray-500">Total Laporan</p>
                <h3 class="text-3xl font-semibold mt-2">32</h3>
                <p class="text-sm text-blue-600 mt-1">+12% dari minggu lalu</p>
            </div>
    
            <div class="bg-white p-4 rounded-2xl shadow-sm">
                <p class="text-gray-500">Tingkat Keaktifan</p>
                <h3 class="text-3xl font-semibold mt-2">87%</h3>
