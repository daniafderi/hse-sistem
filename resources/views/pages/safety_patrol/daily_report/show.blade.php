<x-layouts.app title="Laporan Detail">
    <div class="min-h-screen px-4 sm:px-6 lg:px-0" x-data="{ preview: false, imageSrc: '', openModal: false }">
        ...
        <div class="mx-auto">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        ...
                        <span
                            class="inline-block mt-1 sm:mt-0 text-xs px-3 py-1 rounded-full font-medium border
            ...
            <div class="bg-white rounded-xl shadow-sm border p-4 sm:p-6 mb-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <ul class="text-sm text-gray-600 space-y-2">
                        <li><span class="font-medium w-32 inline-block">Tanggal</span> : {{ $dailyReport->tanggal }}
                        </li>
                        <li><span class="font-medium w-32 inline-block">Lokasi</span> :
                            {{ $dailyReport->project->lokasi }}</li>
                        <li><span class="font-medium w-32 inline-block">Jam Kerja</span> : {{ $dailyReport->jam_kerja }}
                            Jam</li>
                        <li><span class="font-medium w-32 inline-block">Pekerja</span> :
                            {{ $dailyReport->jumlah_pekerja }} Orang</li>
            ...
            <div x-data="{ confirmDelete: false }" class="p-6 mt-6 bg-white rounded-lg shadow-sm border border-gray-100">
                ...
                <div class="flex items-start sm:items-center justify-between gap-4 flex-wrap">
                    <div class="min-w-[200px]">
                        <h2 class="text-lg font-semibold text-gray-800">Hapus Laporan</h2>
                        <p class="text-sm text-gray-500 mt-1">
                            Menghapus laporan juga akan menghapus semua temuan terkait.
                        </p>
                    </div>
                ...
                <div x-show="confirmDelete" class="fixed inset-0 bg-black/40 flex items-center justify-center p-4 z-50"
                    ...
                    <div class="bg-white w-full max-w-sm rounded-lg p-6 shadow-xl" x-transition.scale>
                        ...
                        <div class="flex items-center justify-end gap-3 mt-6">
                            ...
                            <form method="POST" action="{{ route('daily-report.destroy', $dailyReport->id) }}">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
            ...
            <div x-show="preview" x-transition
                ...
                <button @click="preview=false" class="absolute top-4 right-4 bg-white p-2 rounded-full">✕</button>
            </div>
